...
func (r *regx) getVarName(str string) string {
...
*/
func (r regx) getUrlValues(url, urlReq string) map[string]string {
...
func (r regx) getSubdomainValues(subdomain, requestHost string) map[string]string {
	kv := map[string]string{}
